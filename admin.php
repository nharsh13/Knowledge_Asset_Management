                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form action="database_admin.php" method="post">
                                        ...
                                        <h5 class="fw-normal mb-3 pb-3 text-danger" style="letter-spacing: 1px;">Admin
                                            Login</h5>
                                        ...
                                        <br>
                                        <!-- <a href="user.php"><button class="btn btn-success btn-lg btn-block"
                                                href="upload.php" type="button">Login as User.
                                            </button></a> -->

                                          <a href="user.php">Click here for user login.</a>  
